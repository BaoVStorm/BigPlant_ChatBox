# BigPlant Notes Index

Các note được tách theo chủ đề để dễ học và dễ đọc.
...
- `models-and-embedding.md`: local LLM, embedding model, điểm mạnh/yếu và nơi dùng.
- `noteDB.md`: ghi chú về dữ liệu MongoDB thật.
- `note.md`: mô tả tổng thể hệ thống chatbot hiện tại.
